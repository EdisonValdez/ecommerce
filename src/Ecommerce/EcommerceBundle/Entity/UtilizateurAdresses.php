 ...
 * UtilizateurAdresses
 *
 * @ORM\Table("utilizateursadresses")
 * @ORM\Entity(repositoryClass="Ecommerce\EcommerceBundle\Repository\UtilizateurAdressesRepository")
 */
class UtilizateurAdresses
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Utilizateur\UtilizateurBundle\Entity\Utilizateur", inversedBy="adresses")
